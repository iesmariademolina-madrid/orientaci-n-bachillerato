...
# Si cambian los filtros, limpiamos selecciones que ya no estén disponibles
...
for _, row in df_sel.iterrows():
    ...
    for s in chosen:
        ...
        if v is None or (isinstance(v, float) and pd.isna(v)):
            ...
            # Si el filtro de asignaturas es "solo 0,2", consideramos 0 para cualquier otra ponderación
            if subj_mode == "02" and abs(w - 0.2) > 1e-9:
                w = 0.0
